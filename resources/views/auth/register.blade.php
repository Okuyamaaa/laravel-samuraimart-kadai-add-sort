    ...
    <div class="row justify-content-center">
        <div class="col-md-5">
            ...
            <form method="POST" action="{{route('register')}}">
                ...
                <div class="col-md-7">
                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror samuraimart-login-input" name="name" aytofocus placeholder="侍 太郎">
                    @error('name')
...
<div class="form-group row">
    <label for="email" class="col-md-5 col-form-label text-md-left">メールアドレス<span class="ml-1 samuraimart-require^input-label"><spann  class="samuraimart-require-input-label-text">必須</span></span></label>
